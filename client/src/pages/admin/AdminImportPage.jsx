...
export default function AdminImportPage() {
  ...
  return <div className="min-w-0">
    ...
    <nav aria-label="Import steps" className="mb-6 flex flex-wrap gap-3 text-sm font-bold"><Link to="/admin/import" aria-current={view === 'input' ? 'step' : undefined} className="text-academic underline">1. JSON input</Link><span>→</span><span aria-current={view === 'preview' ? 'step' : undefined}>2. Preview</span><span>→</span><span aria-current={view === 'results' ? 'step' : undefined}>3. Results</span></nav>
